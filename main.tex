...
In 1931, B.O. Koopman introduced an alternative way to represent dynamical systems---a globally linear representation using a linear operator $\mathcal K_t$ on Koopman observables $\mathbf g(\mathbf x)$,
\[
...
\begin{scriptsize}
\\
    \mintinline{shell}{pip install autokoopman}
\end{scriptsize}
    \end{center}
    \end{column}
    \begin{column}{0.5\linewidth}
